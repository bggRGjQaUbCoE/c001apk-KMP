        ...
        Column(
            ...
            ParamsItem(
                ...
                viewModel.setXAppDevice(
                    encodeDevice("${prefs.szlmId}; ; ; ${randomMacAddress()}; $it; ${prefs.brand}; ${prefs.model}; ${prefs.buildNumber}; null")
                )
            }
            ...
            ParamsItem(
                ...
                viewModel.setXAppDevice(
                    encodeDevice("${prefs.szlmId}; ; ; ${randomMacAddress()}; ${prefs.manufacturer}; $it; ${prefs.model}; ${prefs.buildNumber}; null")
                )
                viewModel.setUserAgent(
            ...
            ParamsItem(
                ...
                viewModel.setXAppDevice(
                    encodeDevice("${prefs.szlmId}; ; ; ${randomMacAddress()}; ${prefs.manufacturer}; ${prefs.brand}; $it; ${prefs.buildNumber}; null")
                )
                viewModel.setUserAgent(
            ...
            ParamsItem(
                ...
                viewModel.setXAppDevice(
                    encodeDevice("${prefs.szlmId}; ; ; ${randomMacAddress()}; ${prefs.manufacturer}; ${prefs.brand}; ${prefs.model}; $it; null")
                )
                viewModel.setUserAgent(
